...
export const POST_DEFAULTS: PostSettings = {
  ...
  // makes most of that free, 1.20 first cost two shots on the shadow gate,
  // which is what widened `keepLuma`'s window below from (0.30, 0.05) to
...
export function buildPostChain(
  ...
  const keepLuma = smoothstep(0.42, 0.06, lum)
